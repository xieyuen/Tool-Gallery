...
- 有BUG来找我
![](https://api.fishwo.com/badge/diy/FixBug/Email?radius=4&right_color=3d3d3d&left_color=ff0000)![](https://api.fishwo.com/badge/kook/FixBug?radius=4)
...
>### ~~版本 [*1.3.1*](start-1.3.1-snapshot%20GBK.bat)~~
>~~尝试添加文字颜色失败~~
