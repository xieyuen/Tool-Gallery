@rem 前言
 ...
 @rem 请使用utf-8编码编辑脚本[推荐使用专业编辑器编辑,比如VSCode, Notepad++等]
 @rem Please edit the script using utf-8 encoding
 @rem 以下为脚本内容
...
:Start 
 ...
 @rem "______.jar"填服务器核心名, "-Xmx______"内存占用最大值, "-Xms______"内存占用最小值, 单位M或G(1024M=1G)
  ".\Java18\bin\java.exe" -jar -Dfile.encoding=utf-8 -Xmx______ -Xms______ ______.jar nogui
 set /a n+=1
