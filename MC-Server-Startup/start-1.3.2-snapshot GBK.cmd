...
:CheckServer & :: 检测核心
 echo 自动检测核心中......
 if exist ".\fabric-server-launcher.jar" set "Server=fabric-server-launcher.jar" & echo 检测到核心:fabric-server-launcher.jar & goto Settings
 if exist ".\Forge.jar" set "Server=Forge.jar" & echo 检测到核心:Forge.jar & goto Settings
 if exist ".\quilt-server-launcher.jar" set "Server=quilt-server-launcher.jar" & echo 检测到核心:quilt-server-launcher.jar & goto Settings
